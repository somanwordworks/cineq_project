...
export default async function handler(req, res) {
    ...
    const discoverUrl = `https://api.themoviedb.org/3/discover/movie?with_original_language=en&primary_release_date.gte=${startDate}&primary_release_date.lte=${endDate}&sort_by=revenue.desc&region=US&api_key=${process.env.TMDB_API_KEY}`;
